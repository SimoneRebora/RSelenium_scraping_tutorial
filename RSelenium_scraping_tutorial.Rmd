...
This is a basic tutorial that introduces you to scraping dynamic web pages. It explains how I collected data for the scripts in the [wattpad_analysis](https://github.com/SimoneRebora/Wattpad_analysis) repository.  
